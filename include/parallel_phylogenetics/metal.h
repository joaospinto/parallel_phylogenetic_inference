#ifndef PARALLEL_PHYLOGENETICS_METAL_H_
#define PARALLEL_PHYLOGENETICS_METAL_H_
...
AlignmentPosteriorSampleView PosteriorSamplePrepared(
    AlignmentModelView model, std::span<const Scalar> uniforms,
...
#endif // PARALLEL_PHYLOGENETICS_METAL_H_
